...
--   TODO: change to use the same name as in migration
  CONSTRAINT FK_dqi_product_criteria_evaluation_uuid FOREIGN KEY (product_uuid) REFERENCES pim_catalog_product (uuid) ON DELETE CASCADE
...
--   TODO: change to use the same name as in migration
    CONSTRAINT FK_dqi_product_score_uuid FOREIGN KEY (product_uuid) REFERENCES pim_catalog_product (uuid) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
